  ...
  import { FaClipboardList, FaHistory, FaPlusCircle, FaWhatsapp, FaUserFriends } from "react-icons/fa";
    ...
    return (
      <>
        ...
        >
          ...
          <section className="grid grid-cols-1 xs:grid-cols-2 gap-4 sm:gap-8 mb-8 sm:mb-12 z-10 relative">
            <div
            ...
            >
              ...
              <div>
                <div className={`text-2xl sm:text-3xl font-extrabold ${darkMode ? 'text-white' : 'text-cyan-900'}`}>2</div>
            ...
            >
              <div className="bg-emerald-400/30 rounded-full p-3 flex items-center justify-center">
                <FaHistory className={`text-3xl sm:text-4xl ${darkMode ? 'text-emerald-200' : 'text-emerald-700'}`} />
              </div>
              <div>
                <div className={`text-2xl sm:text-3xl font-extrabold ${darkMode ? 'text-white' : 'text-emerald-900'}`}>5</div>
                <div className={`text-xs sm:text-base font-semibold ${darkMode ? 'text-emerald-100' : 'text-emerald-700'}`}>Riwayat Peminjaman</div>
              </div>
            </div>
          </section>
          <section className={`rounded-3xl shadow-2xl p-3 sm:p-6 md:p-8 mb-8 sm:mb-12 animate-fadein-slow backdrop-blur-xl border border-cyan-200/30 ${darkMode ? 'bg-gray-900/70' : 'bg-white/70'}`}>
            <div className="flex flex-col sm:flex-row justify-between items-center gap-2 mb-5">
              <h2 className={`text-xl sm:text-2xl font-bold flex items-center gap-2 ${darkMode ? 'text-white' : 'text-cyan-900'}`}>
                <FaClipboardList className="text-cyan-400" /> Status Peminjaman
              </h2>
              ...
              <table className="min-w-[350px] w-full text-xs sm:text-sm">
                ...
                <tbody>
                  <tr className={`${darkMode ? 'border-b border-cyan-800/60 hover:bg-cyan-950/60' : 'border-b hover:bg-cyan-50/80'}`}>
                    ...
                    <td className="py-2 px-2 sm:px-4"><span className={`${darkMode ? 'bg-cyan-800/80 text-cyan-100' : 'bg-cyan-200/80 text-cyan-800'} px-2 py-1 rounded font-bold`}>Disetujui</span></td>
                  </tr>
                  <tr className={`${darkMode ? 'border-b border-cyan-800/60 hover:bg-cyan-950/60' : 'border-b hover:bg-cyan-50/80'}`}>
                    ...
                    <td className="py-2 px-2 sm:px-4"><span className={`${darkMode ? 'bg-yellow-700/80 text-yellow-200' : 'bg-yellow-200/80 text-yellow-800'} px-2 py-1 rounded font-bold`}>Menunggu</span></td>
                  </tr>
                  <tr className={`${darkMode ? 'hover:bg-cyan-950/60' : 'hover:bg-cyan-50/80'}`}>
                    ...
                    <td className="py-2 px-2 sm:px-4"><span className={`${darkMode ? 'bg-red-800/80 text-red-200' : 'bg-red-200/80 text-red-800'} px-2 py-1 rounded font-bold`}>Ditolak</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="flex flex-col xs:flex-row flex-wrap gap-4 sm:gap-6 mt-2 mb-2 sm:mb-0 z-10 relative">
            ...
            <a
              href="https://wa.me/62895320695308?text=Halo%20Admin%2C%20saya%20ingin%20menanyakan%20tentang%20fasilitas%20desa.%20Mohon%20informasinya.%20Terima%20kasih."
              target="_blank"
              rel="noopener noreferrer"
              className={`w-full xs:w-auto px-7 py-4 rounded-2xl shadow-xl border-2 font-bold flex items-center justify-center gap-3 transition text-center text-lg sm:text-xl
                ${darkMode ? 'bg-gradient-to-r from-green-600 via-emerald-600 to-emerald-700 border-emerald-800 text-white hover:from-green-700 hover:to-emerald-800 active:scale-95' : 'bg-gradient-to-r from-green-400 via-emerald-400 to-emerald-500 border-emerald-300 text-white hover:from-green-500 hover:to-emerald-600 active:scale-95'}`}
            >
              <span className="bg-white/20 rounded-full p-2 flex items-center justify-center"><FaWhatsapp className="text-xl sm:text-2xl text-green-200" /></span>
              Kontak Admin
            </a>
          </section>
          <style jsx global>{`
